        ...
        <div className="w-full lg:max-w-md">
          <div className="mb-8 lg:mb-10 lg:text-left">
            ...
            <p className="max-w-sm text-[15px] leading-relaxed text-board-tile/65">
              Trade properties, collect rent, and bankrupt your friends —
              live, in the browser, with up to 10 players.
            </p>
          </div>
          ...
          <div className="w-full rounded-2xl border border-brass/20 bg-board p-6 shadow-board texture-parchment sm:p-7">
            {!mode && (
              <div className="flex flex-col gap-3">
                ...
                >
                  <span className="block text-base">Host a new game</span>
                  <span className="block text-xs font-normal text-brass-ink/70">Get a room code to share</span>
                </button>
                <button
                  type="button"
                ...
                >
                  <span className="block text-base">Join with a code</span>
                  <span className="block text-xs font-normal text-ink-faint">Enter a friend's room code</span>
                </button>
              </div>
            )}
    ...
    <div className="relative min-h-screen overflow-hidden px-6 py-12">
      ...
      <div className="mx-auto flex max-w-2xl flex-col justify-center" style={{ minHeight: 'calc(100vh - 6rem)' }}>
        <div className="mb-7 text-center">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.2em] text-board-tile/50">Room code</p>
        ...
        <div className="rounded-2xl border border-brass/20 bg-board p-6 shadow-board texture-parchment sm:p-7">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-display text-xl font-semibold text-ink">
              Players <span className="text-ink-faint">({gameState.players.length}/10)</span>
            </h2>
          ...
          {seatsLeft > 0 && (
            <p className="mt-3 text-center text-xs text-ink-faint">
              {seatsLeft} {seatsLeft === 1 ? 'seat' : 'seats'} open — share the code above
            </p>
          )}
